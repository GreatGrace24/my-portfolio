    ...
    <nav className="fixed top-0 left-0 w-full bg-white shadow-md z-50">
      ...
      {isOpen && (
        <ul className="md:hidden bg-white shadow-md px-6 py-4 space-y-4 text-gray-700 font-medium">
          <li><a href="#about" className="block hover:text-red-600 transition" onClick={() => setIsOpen(false)}>About</a></li>
          <li><a href="#projects" className="block hover:text-red-600 transition" onClick={() => setIsOpen(false)}>Projects</a></li>
          <li><a href="#contact" className="block hover:text-red-600 transition" onClick={() => setIsOpen(false)}>Contact</a></li>
        </ul>
      )}
    </nav>
  );
